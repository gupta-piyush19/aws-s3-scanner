/**
 * GET /results Lambda Handler
 * Retrieves findings with optional filters and cursor-based pagination
 */
...
exports.handler = async (event) => {
  ...
  try {
    ...
    // Build query
    let query = 'SELECT id, job_id, bucket, key, detector, masked_match, context, byte_offset, created_at FROM findings WHERE 1=1';
    const values = [];
    let paramIndex = 1;
